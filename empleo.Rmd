...
g1 <- ggplot(data = db2, aes(x = year, y = informalidad, 
  ...
  labs(x = "Años", y = "Porcentaje de ocupados", title = "Porcentaje de ocupados que trabajan en el sector informal de la economía", caption = "Fuente: INE.")
...
g2 <- ggplot(data = db2, aes(x = year, y = desempleo, 
  ...
  geom_line(aes(group = 1), colour = "#00AFBB") + geom_point(colour = "#00AFBB", size = 3) +
  scale_x_discrete(limits = c("2000", "2001", "2002", "2005", "2006", "2007", "2008", "2009", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019" )) +  theme_gray() + 
  labs(x = "Años", y = "Porcentaje de la población económicamente activa", title = "Porcentaje de la población económicamente activa que se encuentran desocupados", caption = "Fuente: INE.")
...
g3 <- ggplot(data = db3, aes(x = year, y = value, group = variable, 
  ...
  scale_x_discrete(limits = c("2000", "2001", "2002", "2005", "2006", "2007", "2008", "2009", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019")) +  theme_gray() + 
  labs(x = "Años", y = "Porcentaje de la población económicamente activa", title = "Tasa de ocupación según género", caption = "Fuente: INE.", color = "Género")
...
g4 <- ggplot(data = db5, aes(x = year, y = value, group = variable, 
                             ...
                             text = paste("Año: ", year, "<br>Tasa: ", round(value,2) ))) + geom_line() + geom_point() +
  scale_x_discrete(limits = c("2000", "2001", "2002", "2005", "2006", "2007", "2008", "2009", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019")) +  theme_gray() + 
  labs(x = "Años", y = "Porcentaje de la población ocupada", title = "Descompsición de la población ocupada según actividad económica", caption = "Fuente: INE.", color = "Sector")
...
g5 <- ggplot(data = db, aes(x = year, y = productividad, 
  ...
  labs(x = "Años", y = "Producto por trabajador", title = "Producto por trabajador (PIB en $us a precios constantes 2010)", caption = "Fuente: ILOSTAT.")
