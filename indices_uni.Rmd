---
title: "INDICADORES E ÍNDICES ELECTORALES - ELECCIONES PARA DIPUTADOS UNINOMINALES"
output: 
...
db1<-db %>% rename(p21F=19) %>%  filter(Elección==unique(Elección)[2]) %>% group_by(País)%>% summarise(CC=sum(CC),MAS=sum(`MAS - IPSP`),PDC=sum(PDC),P21F=sum(p21F),Resto=sum(FPV,MTS,UCS,MNR,`PAN-BOL`), INSCRITOS=sum(Inscritos), VALIDOS=sum(`Votos Válidos`)) 

db2<-db %>% rename(p21F=19) %>%  filter(Elección==unique(Elección)[2] & País=="Bolivia") %>% group_by(Departamento)%>% summarise(CC=sum(CC),MAS=sum(`MAS - IPSP`),PDC=sum(PDC),P21F=sum(p21F),Resto=sum(FPV,MTS,UCS,MNR,`PAN-BOL`), INSCRITOS=sum(Inscritos), VALIDOS=sum(`Votos Válidos`)) 

db3<-db %>% rename(p21F=19) %>%  filter(Elección==unique(Elección)[2] & País=="Bolivia") %>% group_by(Departamento,Provincia)%>% summarise(CC=sum(CC),MAS=sum(`MAS - IPSP`),PDC=sum(PDC),P21F=sum(p21F),Resto=sum(FPV,MTS,UCS,MNR,`PAN-BOL`), INSCRITOS=sum(Inscritos), VALIDOS=sum(`Votos Válidos`)) 

db4<-db %>% rename(p21F=19) %>%  filter(Elección==unique(Elección)[2] & País=="Bolivia") %>% group_by(Departamento,Provincia,Municipio)%>% summarise(CC=sum(CC),MAS=sum(`MAS - IPSP`),PDC=sum(PDC),P21F=sum(p21F),Resto=sum(FPV,MTS,UCS,MNR,`PAN-BOL`), INSCRITOS=sum(Inscritos), VALIDOS=sum(`Votos Válidos`)) 

db5<-db %>% rename(p21F=19) %>%  filter(Elección==unique(Elección)[2] & País=="Bolivia") %>% group_by(Departamento,Provincia,Municipio,Circunscripción)%>% summarise(CC=sum(CC),MAS=sum(`MAS - IPSP`),PDC=sum(PDC),P21F=sum(p21F),Resto=sum(FPV,MTS,UCS,MNR,`PAN-BOL`), INSCRITOS=sum(Inscritos), VALIDOS=sum(`Votos Válidos`)) 

db6<-db %>% rename(p21F=19) %>%  filter(Elección==unique(Elección)[2] & País=="Bolivia") %>% group_by(Departamento,Provincia,Municipio,Circunscripción,Localidad)%>% summarise(CC=sum(CC),MAS=sum(`MAS - IPSP`),PDC=sum(PDC),P21F=sum(p21F),Resto=sum(FPV,MTS,UCS,MNR,`PAN-BOL`), INSCRITOS=sum(Inscritos), VALIDOS=sum(`Votos Válidos`)) 

db7<-db %>% rename(p21F=19) %>%  filter(Elección==unique(Elección)[2] & País=="Bolivia") %>% group_by(Departamento,Provincia,Municipio,Circunscripción,Localidad,Recinto)%>% summarise(CC=sum(CC),MAS=sum(`MAS - IPSP`),PDC=sum(PDC),P21F=sum(p21F),Resto=sum(FPV,MTS,UCS,MNR,`PAN-BOL`), INSCRITOS=sum(Inscritos), VALIDOS=sum(`Votos Válidos`)) 
