...
g1 <- ggplot(data = db, aes(x = year, y = construccion, fill = level,  
  ...
  labs(x = "Años", y = "Número de establecimientos de salud", title = "Número de establecimientos de salud, \n según nivel", fill = "Nivel")
...
g2 <- ggplot(data = db1, aes(x = year, y = seguro,  
  ...
  labs(x = "Años", y = "En porcentaje", title = "Porcentaje de personas que cuentan \n con seguro de salud")
...
g3 <- ggplot(data = db1, aes(x = year, y = mort_inf, 
  ...
  scale_x_discrete(limits = c(2010:2019)) +  theme_gray() + 
  labs(x = "Años", y = "En porcentaje", title = "Tasa de mortalidad, menores de 5 años (por cada 1.000)", caption = "Fuente: BM.")
...
g4 <- ggplot(data = db2, aes(x = year, y = prev_anemia, 
  ...
  labs(x = "Años", y = "En porcentaje", title = "Prevalencia de anemia en la infancia (% de menores de 5 años)", caption = "Fuente: BM.")
...
g5 <- ggplot(data = db2, aes(x = year, y = m_adolescent,  
  ...
  labs(x = "Años", y = "En porcentaje", title = "Madres adolescentes (% de mujeres entre 15 y 19 años que \n tuvieron hijos o se encuentran embarazadas)", caption = "Fuente: BM.")
