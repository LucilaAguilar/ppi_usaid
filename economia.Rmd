...
library(scales)
# Base de datos
#db<-load(url("https://github.com/LucilaAguilar/ppi_usaid/tree/main/_data/data_economics.xlsx"))
#setwd("C:\\Users\\lenin\\OneDrive\\Documentos\\GitHub\\ppi_usaid\\_data")
db <- as.data.frame(read_excel(load(url("https://github.com/LucilaAguilar/ppi_usaid/tree/main/_data/data_economics.xlsx")), range = "A1:H11", col_names = T), stringsAsFactor = T)
